...
### 4.2 การสุ่มทำลายข้อมูล 7% (Data Corruption)
สคริปต์จะนำรายการข้อมูลทั้งหมดมาสับเปลี่ยนลำดับแบบสุ่ม (Fisher-Yates Shuffle) จากนั้นเลือกข้อมูลจำนวน **7%** (155 แถวจาก 2,220 แถว) เพื่อทำลายความถูกต้องของข้อมูลตามรูปแบบ 5 แบบเท่าๆ กัน:
