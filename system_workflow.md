...
สเตจนี้ทำงานต่อเนื่องหลังจากการนำข้อมูลดิบเข้าสู่ `pumpui_erp` เพื่อสุ่มสับเปลี่ยนและคัดแยกข้อมูลจำนวน **7%** มาจำลองสภาวะข้อมูลเสียหาย (Data Quality Errors)

```mermaid
graph TD
    Data[ชุดข้อมูลดิบทั้งหมด 2,220 แถว] --> Shuffle[สับเปลี่ยนลำดับข้อมูลแบบสุ่มใน Array]
    Shuffle --> Cut[เลือกข้อมูลออกมา 7% หรือจำนวน 155 แถว]
    
    Cut --> Split{แบ่งเป็นกลุ่มข้อผิดพลาด 5 กลุ่ม กลุ่มละ 31 แถว}
